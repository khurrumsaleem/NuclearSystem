...
model KineticReactor_00
  ...
  parameter Real PHI0_par "neutron flux, 1/(m2*s)";
  ...
  parameter NuclearSystem.Types.Switches.switch_causal_neutronFlux switchCausal_PHI0= NuclearSystem.Types.Switches.switch_causal_neutronFlux.PHI2den annotation (Dialog(group="Switches"));
