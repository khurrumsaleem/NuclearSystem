...
model KineticReactor_PromptNeutron_00_ex01
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValue_pwr(significantDigits = 4) annotation(
    Placement(transformation(origin = {1, -60}, extent = {{-17, -9}, {17, 9}})));
...
equation
  connect(PtRctr.y_pwrRel0, realValue_pwr.numberPort) annotation(
    Line(points = {{-31, -6}, {-27, -6}, {-27, -60}, {-19, -60}}, color = {0, 0, 127}));
...
1.0 ton iron", horizontalAlignment = TextAlignment.Left), Text(origin = {31, -32}, extent = {{-11, 4}, {11, -4}}, textString = "[MW]"), Text(origin = {4, -26}, extent = {{-14, 6}, {14, 0}}, textString = "Reactor power", horizontalAlignment = TextAlignment.Left), Text(origin = {-1, -54}, extent = {{-19, 12}, {19, 0}}, textString = "Reactor power
