...
model KineticReactor_VariableVolume_01
  ...
  Kinetics.Components.KineticReactor_00 PtRctr(PHI0_par = 1e19, denNnukeFuel_par = 0.95*(18.71*10^6/238)*Constants.UnitConversions.factor_mole2num(), switchCausal_PHI0 = NuclearSystem.Types.Switches.switch_causal_neutronFlux.PHI2den, use_u_Vol = true) annotation(
...
equation
  ...
  connect(PtRctr.y_pwrRel0, realValue_pwr.numberPort) annotation(
    Line(points = {{119, 74}, {147.55, 74}, {147.55, 13.4}, {159.55, 13.4}}, color = {0, 0, 127}));
  ...
  connect(ramp_rho.y, PtRctr.u_rho) annotation(
    Line(points = {{69, 84}, {82, 84}}, color = {0, 0, 127}));
