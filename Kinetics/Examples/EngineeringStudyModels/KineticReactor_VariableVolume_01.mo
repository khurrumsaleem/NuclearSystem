...
model KineticReactor_VariableVolume_01
  ...
  Kinetics.Components.KineticReactor_00 PtRctr(PHI0_par = 1e15, denNnukeFuel_par = 0.95*(18.71*10^6/238)*Constants.UnitConversions.factor_mole2num(), switchCausal_PHI0 = NuclearSystem.Types.Switches.switch_causal_neutronFlux.PHI2den, use_u_Vol = true) annotation(
